...
class TestTournament {
  ...
  // Matches
  static final onGoingMatchesInsertQuery = '''
  ...
  // MatchesSession
  static final onGoingMatchesSessionInsertQuery = '''
  ...
  // PlayerSession
  static final onGoingPlayerSessionInsertQuery = '''
